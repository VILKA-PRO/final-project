...
class AdminOfferController extends Controller
{
    public function offerPage($id)
    {
        ...
        if (!$offer) {
            return redirect()->route('admin_panel')->with('status', 'Запись не найдена');
        }
    ...
    public function unSubscribe(Request $request, $id)
    {
        ...
        if (!$subscription) {
            ...
            $subscription->save();
            $message = 'Вы успешно отписались от оффера.';
        }
        ...
        return redirect()->route('admin_panel')->with('status', $message);
    }
